 ...
 * @constructor
 */
var JsModule = exports.JsModule = function(name, parent, jsSources,
    inputSources) {
...
JsModule.isClosureBaseFile = function(jsSource) {
  return 'base.js' == path.basename(jsSource.getPath()) &&
 ...
 */
JsModule.prototype._wrapper = null;
...
JsModule.prototype._getBaseFileSource = function(callback) {
  ...
  if (1 == baseFileSources.length) {
    ...
    baseFileSources.forEach(function(baseFile) {
      errorMessage.push(baseFile.getPath());
    });
...
JsModule.prototype.calculateDeps = function(callback) {
  try {
    var tree = new depstree.DepsTree(this._jsSources);
